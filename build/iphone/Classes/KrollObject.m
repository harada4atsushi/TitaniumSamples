 ...
 * Copyright (c) 2009-2011 by samples, Inc. All Rights Reserved.
...
//@interface samplesObject : NSObject
//@end

@interface samplesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[samplesObject class]])
		{
			for (NSString *key in [[(samplesObject*)o modules] allKeys])
			{
