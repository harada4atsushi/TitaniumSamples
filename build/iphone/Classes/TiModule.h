...
/**
 The base class for all samples modules
 */
...
/**
 samples Platform calls this method on startup.
 */
-(void)startup;

/**
 samples Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 samples Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 samples Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 samples Platform calls this method on resume.
 @param sender The sender of the event.
 */
