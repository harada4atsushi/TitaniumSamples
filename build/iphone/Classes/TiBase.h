...
// in simulator we redefine to format for samples Developer console
...
{\
	NSString * exceptionName = [@"org.samples." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.samples";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIsamplesNativeItemNone = -1, 
	UIsamplesNativeItemSpinner = -2,
	UIsamplesNativeItemProgressBar = -3,
	
	UIsamplesNativeItemSlider = -4,
	UIsamplesNativeItemSwitch = -5,
	UIsamplesNativeItemMultiButton = -6,
	UIsamplesNativeItemSegmented = -7,
	
	UIsamplesNativeItemTextView = -8,
	UIsamplesNativeItemTextField = -9,
	UIsamplesNativeItemSearchBar = -10,
	
	UIsamplesNativeItemPicker = -11,
	UIsamplesNativeItemDatePicker = -12,
	
	UIsamplesNativeItemInfoLight = -13,
	UIsamplesNativeItemInfoDark = -14,
	
	UIsamplesNativeItemDisclosure = -15,
	
	UIsamplesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all samples instances of
